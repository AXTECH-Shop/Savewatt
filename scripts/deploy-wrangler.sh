...
mkdir -p "$OUTPUT_DIR/public/vendor/gsap"

cp index.html styles.css script.js _headers "$OUTPUT_DIR/"
...
cp -R public/assets/generated-v4 "$OUTPUT_DIR/public/assets/"
cp public/vendor/gsap/*.min.js "$OUTPUT_DIR/public/vendor/gsap/"
